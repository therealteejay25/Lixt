...
export { auth, provider, db, collection, addDoc, doc, updateDoc, deleteDoc, onAuthStateChanged, signInWithPopup, GoogleAuthProvider, getAuth, query, where, onSnapshot };

...
export { auth, provider, db, collection, addDoc, doc, updateDoc, deleteDoc, onAuthStateChanged, signInWithPopup, GoogleAuthProvider, getAuth, signInWithPopup, query, where, onSnapshot };
